...
# Studio SSO (WorkOS, Auth0, …) is gated behind an EE license check in
# production. Self-hosted Factory uses operator-owned WorkOS, so enable the
# documented MASTRA_DEV escape hatch so /studio can show "Sign in with WorkOS"
# without MASTRA_LICENSE_KEY. See mastra-ai/mastra#14619.
ENV MASTRA_DEV=true
